# -*- coding: utf-8 -*-
"""
Created on Sat Apr 21 22:33:58 2018
...
# We shall load all the training and validation images and labels into memory using openCV and use that during training
    train_images,train_labels,validation_images,validation_labels = dataset.read_train_sets(train_path, img_size, classes, validation_size=validation_size)
